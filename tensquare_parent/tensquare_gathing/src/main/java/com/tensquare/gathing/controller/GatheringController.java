package com.tensquare.gathing.controller;
...
import com.tensquare.gathing.service.GatheringService;
...
public class GatheringController {
	...
	public Result update(@RequestBody Gathering gathering, @PathVariable String ids ){
