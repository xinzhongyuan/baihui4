...
public class UserController {
	...
	public Result register(@PathVariable  String phonenum){
		userService.send_phone_massage(phonenum);
	...
	@PostMapping("/login")
	public Result fingByMobileAndpassword(@RequestBody  Map<String ,String> loginMap){
		...
		if(user !=null){
			...
			return new Result(true,StatusCode.ERROR,"查无此人");
		}
	}
